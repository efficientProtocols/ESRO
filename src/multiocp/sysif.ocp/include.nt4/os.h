...
/*
 * RCS Revision: $Id: os.h,v 1.3 2002/09/28 22:27:25 mohsen Exp $
 */
...
#elif defined(_WINNT)	/* _WIN32_WCE defined/used by Microsoft */

# define	OS_VARIANT_WinNT
# define	OS_VARIANT_Dos
# define	OS_NAME			"Microsoft Windows NT"
...
#if defined(OS_VARIANT_Windows) || defined(OS_VARIANT_QuickWin) || defined(OS_VARIANT_WinCE) || defined(OS_VARIANT_WinNT)
# include <windows.h>
#ifndef _GCC_
# include <winsock.h>
#endif
