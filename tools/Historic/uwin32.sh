# RCS: $Id: uwin32.sh,v 1.1 2002/10/25 23:47:44 mohsen Exp $
#
...
typeset UWIN_PATH_winVersion=`winpath ${UWIN_PATH} | sed -e 's:\\\\:\\\\\\\\:g'`

LB="${UWIN_PATH_winVersion}\ksh.exe win32lib.sh -c ${targetCPU} -s ${targetOS}"
RANLIB="echo Done Building"
#LK="${MKSPATH}\sh.exe wcelink.ksh -c ${targetCPU}"
LK="${UWIN_PATH_winVersion}\ksh.exe win32link.sh -c ${targetCPU} -s ${targetOS}"
RC=rc
HC="hcrtf -xn"
ETAGS=etags
AS="tasm"
...
typeset KSHCURENVBASE_winVersion=`winpath $KSHCURENVBASE | sed -e 's:\\\\:\\\\\\\\:g'`
typeset DEVSTUDIOPATH_winVersion=`winpath $DEVSTUDIOPATH | sed -e 's:\\\\:\\\\\\\\:g'`

  case ${targetPDT} in
    'BASEUA.ALL' )
      INCL="-I."
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\this\\\\include"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\include\\\\dos"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\mts_ua\\\\include"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\esros\\\\include"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\ocp\\\\include"
      INCL="${INCL} -I${DEVSTUDIOPATH_winVersion}\\\\VC98\\\\Include"
      ;;
    'OCPDEVL.MUL' )
      INCL="-I."
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\this\\\\include.nt4"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\multiocp\\\\sysif.ocp\\\\include.nt4"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\multiocp\\\\include.ocp"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\esros\\\\include"
      INCL="${INCL} -I${DEVSTUDIOPATH_winVersion}\\\\VC98\\\\Include"
      ;;
    'esrosSDK')
      INCL="-I."
    ...
    'VORDE' )
      ...
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\mts_ua\\\\include"
    ...
    'UADEVL.MUL' )
      INCL="-I."
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\multiocp\\\\this\\\\include.nt4"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\multiocp\\\\sysif.ocp\\\\include.nt4"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\mts_ua\\\\include"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\esros\\\\include"
      INCL="${INCL} -I${KSHCURENVBASE_winVersion}\\\\src\\\\multiocp\\\\include.ocp"
...
#   'BASEUA.ALL' )
#     INCL="-I."
#     INCL="${INCL} -I${KSHCURENVBASE}/this/include"
...
#     'OCPDEVL.MUL' )
#       INCL="-I."
#       INCL="${INCL} -I${KSHCURENVBASE}/src/this/include.nt4"
...
#       INCL="-I."
#       INCL="${INCL} -I`winpath ${KSHCURENVBASE}/src/this/include.nt4`"
#       INCL="${INCL} -I`winpath ${KSHCURENVBASE}/src/multiocp/sysif.ocp/include.nt4`"
#       # NOTEYT -- Figure a way of amking this independent
#       #INCL="${INCL} -Id:/Dialogic3.1/INC"
#       INCL="${INCL} -I`winpath ${DialogicBase}/INC`"

#       INCL="${INCL} -I`winpath ${KSHCURENVBASE}/src/mts_ua/include`"

#       INCL="${INCL} -I`winpath ${KSHCURENVBASE}/src/esros/include`"

#       INCL="${INCL} -I`winpath ${KSHCURENVBASE}/src/multiocp/include.ocp`"
#       INCL="${INCL} -I`winpath /C/DevStudio60/VC98/Include`"
#       ;;
#     'UADEVL.MUL' )
#       INCL="-I."
#       INCL="${INCL} -I${KSHCURENVBASE}/src/multiocp/this/include.nt4"
#       INCL="${INCL} -I${KSHCURENVBASE}/src/multiocp/sysif.ocp/include.nt4"
...
LIBS_PATH="${KSHCURENVBASE_winVersion}\\\\results\\\\${resultsOS}\\\\${resultsCPU}\\\\libc"
BIN_PATH="${KSHCURENVBASE_winVersion}\\\\results\\\\${resultsOS}\\\\${resultsCPU}\\\\bin"
MAN_PATH=""
DATA_PATH=""
